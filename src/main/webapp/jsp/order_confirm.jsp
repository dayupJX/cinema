  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u579" class="ax_default image">
        <img id="u579_img" class="img " src="images/首页/u2.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u581" class="ax_default text_field">
        <input id="u581_input" type="text" value="默认城市（定位） | 根据ip地址所定位的位置"/>
      </div>

      <!-- Unnamed (矩形) -->
      <div id="u582" class="ax_default primary_button">
      ...
      <div id="u584" class="ax_default image">
        <img id="u584_img" class="img " src="images/首页/u8.png"/>
        <!-- Unnamed () -->
      ...
      <!-- Unnamed (文本框) -->
      <div id="u586" class="ax_default text_field">
        <input id="u586_input" type="text" value="&nbsp; 登录"/>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u587" class="ax_default text_field">
        <input id="u587_input" type="text" value="&nbsp; 注册"/>
      </div>
      ...
      <!-- Unnamed (椭圆形) -->
      <div id="u590" class="ax_default ellipse">
        <img id="u590_img" class="img " src="images/选座购票/u379.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u592" class="ax_default line">
        <img id="u592_img" class="img " src="images/选座购票/u381.png"/>
        <!-- Unnamed () -->
      ...
      <!-- Unnamed (椭圆形) -->
      <div id="u594" class="ax_default ellipse">
        <img id="u594_img" class="img " src="images/选座购票/u379.png"/>
        <!-- Unnamed () -->
      ...
      <!-- Unnamed (椭圆形) -->
      <div id="u596" class="ax_default ellipse">
        <img id="u596_img" class="img " src="images/选座购票/u379.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u598" class="ax_default line">
        <img id="u598_img" class="img " src="images/选座购票/u387.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u600" class="ax_default line">
        <img id="u600_img" class="img " src="images/选座购票/u389.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u602" class="ax_default ellipse">
        <img id="u602_img" class="img " src="images/选座购票/u379.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u604" class="ax_default line">
        <img id="u604_img" class="img " src="images/选座购票/u389.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u606" class="ax_default image">
        <img id="u606_img" class="img " src="images/首页/u8.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u608" class="ax_default image">
        <img id="u608_img" class="img " src="images/首页/u8.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u610" class="ax_default image">
        <img id="u610_img" class="img " src="images/首页/u8.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u612" class="ax_default image">
        <img id="u612_img" class="img " src="images/首页/u8.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u620" class="ax_default line">
        <img id="u620_img" class="img " src="images/确认订单/u620.png"/>
        <!-- Unnamed () -->
      ...
      <!-- Unnamed (矩形) -->
      <div id="u622" class="ax_default box_3">
      ...
      <div id="u626" class="ax_default label">
        ...
        <div id="u627" class="text" style="visibility: visible;">
          <p><span>您当前绑定的手机号为：</span></p><p><span><br></span></p>
        </div>
      </div>
      ...
      <div id="u628" class="ax_default label">
        ...
        <div id="u629" class="text" style="visibility: visible;">
          <p><span>89757487</span></p>
        </div>
      </div>

      <!-- Unnamed (图片) -->
      <div id="u630" class="ax_default image">
        <img id="u630_img" class="img " src="images/确认订单/u630.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u634" class="ax_default image">
        <img id="u634_img" class="img " src="images/首页/u121.png"/>
        <!-- Unnamed () -->
