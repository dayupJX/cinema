...
<!--               <img id="u13_img" class="img " src="images/首页/u13.png"/> -->
              <img id="u13_img" class="img " src="${pageContext.request.contextPath}/images/${content.pic1}"/>
              <!-- Unnamed () -->
...
<!--               <img id="u15_img" class="img " src="images/首页/u13.png"/> -->
              <img id="u15_img" class="img " src="${pageContext.request.contextPath}/images/${content.pic2}"/>
              <!-- Unnamed () -->
...
<!--               <img id="u21_img" class="img " src="images/首页/u13.png"/> -->
              <img id="u21_img" class="img " src="${pageContext.request.contextPath}/images/${content.pic3}"/>
              <!-- Unnamed () -->
